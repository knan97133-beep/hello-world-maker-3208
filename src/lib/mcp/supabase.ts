/**
 * supabase.ts — Supabase client factory for MCP tools.
 * -------------------------------------------------------------
 * Import-safe: no env reads at module scope. Tools call
 * `supabaseForUser(ctx)` so RLS runs as the signed-in student.
 */
